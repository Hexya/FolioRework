...
export default class TypingEffect {
    ...
    constructor(contText1,timeDelay0,contText2,contText3,timeDelay1,contText4,timeDelay2) {

        let txt1 = document.querySelector(contText1);
        new ConvertSpan(txt1);

        let tl = new TimelineLite();
        tl.staggerFrom(txt1.querySelectorAll('span'),0.1, {autoAlpha:0},0.05,timeDelay0)
        if(contText2) {
